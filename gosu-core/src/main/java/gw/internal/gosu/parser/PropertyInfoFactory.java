...
public class PropertyInfoFactory
{
    ...
    throws IntrospectionException
  {
    ...
    return JavaPropertyInfo.newInstance( container, new PropertyDescriptorJavaPropertyDescriptor(property), propertyType );
  }
    ...
    throws IntrospectionException
  {
    PropertyDescriptor property = new PropertyDescriptor( strName, javaClass, strGetter, strSetter );
    BeanInfoUtil.makeScriptable( property );
    return JavaPropertyInfo.newInstance( container, new PropertyDescriptorJavaPropertyDescriptor(property), propertyType, presInfo );
  }
