...
class Errant_BlocksGenericsWithoutParams {
  ...
  function caller() {
    ...
    var x1311: ArrayList<Integer> = hello1(\-> new ArrayList())  //## issuekeys: 'HELLO1(GW.LANG.__PSI__.IBLOCK0<T>)' IN 'TEST.GOSU.GW.SPECCONTRIB.AAA.PARSERVSOPENSOURCE.BLOCKS.BLOCKSMAIN.ERRANT_BLOCKSGENERICSWITHOUTPARAMS' CANNOT BE APPLIED TO '(BLOCK():ARRAYLIST)'
